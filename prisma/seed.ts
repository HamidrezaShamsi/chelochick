...
async function main() {
  ...
  await db.menuItem.createMany({
    data: [
      { name: "Classic Checlo", description: "Crispy chicken, pickles, sauce", priceCents: 999, categoryId: cat.id },
      { name: "Spicy Checlo", description: "Spicy sauce, jalapeños", priceCents: 1099, categoryId: cat.id },
